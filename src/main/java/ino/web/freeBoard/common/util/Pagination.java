...
//				buffer.append("<span><a href=\"" + this.url + "?page=" + i + "\">" + i + "</a></span>");
				buffer.append("<span><a href=\"javascript:boardSearch(" + i + ")\">" + i + "</a></span>");
		}
